...
var font = 'https://raw.githubusercontent.com/AndyBay/seti-ui/master/styles/_fonts/seti/seti.woff';
...
var fontMappings = 'https://raw.githubusercontent.com/AndyBay/seti-ui/master/styles/_fonts/seti.less';
var mappings = 'https://raw.githubusercontent.com/AndyBay/seti-ui/master/styles/components/icons/mapping.less';
var colors = 'https://raw.githubusercontent.com/AndyBay/seti-ui/master/styles/ui-variables.less';
...
exports.update = function () {
	...
	function writeFileIconContent(info) {
      ...
      version: 'https://github.com/AndyBay/seti-ui/commit/' + info.commitSha,
		};

		// var path = './icons/vs-seti-icon-theme.json';
		var path = './icons/RubyGeorge_seti.json';
	...
	return download(fontMappings).then(function (content) {
		...
		return download(mappings).then(function (content) {
			...
			return download(colors).then(function (content) {
				...
				return getCommitSha('AndyBay/seti-ui', 'styles/_fonts/seti.less').then(function (info) {
					try {
						writeFileIconContent(info);
						if (info) {
							// console.log('Updated to jesseweed/seti-ui@' + info.commitSha.substr(0, 7) + ' (' + info.commitDate.substr(0, 10) + ')');
							console.log('Updated to AndyBay/seti-ui@' + info.commitSha.substr(0, 7) + ' (' + info.commitDate.substr(0, 10) + ')');
						}
